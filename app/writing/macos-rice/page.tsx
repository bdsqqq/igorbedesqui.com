...
const ScrollableCodeWithCopy = (
  ...
  return (
    <Border>
      <pre className="bg-gray-02 relative -mx-4 my-2 rounded-sm text-sm">
        <ScrollArea className={cn("p-4", props.heightclassname)}>
          <code
            className={cn("bg-gray-02 rounded font-mono", props.className)}
            {...props}
          />
...
`}
            ...
            <LightBox
              className="bg-gray-01 -mx-4 rounded-sm"
