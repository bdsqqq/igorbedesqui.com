    ...
    <Container key="the-manual" backable backMessage={psykipMeta.backMessage}>
      ...
      <div className="flex flex-col gap-20">
        <Band gridless id="why">
          <div className={cx(g)}>
            <div className="col-span-5 space-y-2 text-xl lg:col-span-7 lg:col-start-5">
              <MDX>
                {`
        ...
        <Band gridless id="direction">
          <div className={cx(g, "space-y-4")}>
            ...
            <div className="col-span-5 md:col-start-2 lg:col-start-5 lg:col-end-13">
            ...
            <div className="col-start-13 col-end-17">
        ...
        <Band gridless id="visual">
          <div className={cx(g, "space-y-4")}>
            <h3 className="col-start-1 col-end-13 mb-4 text-2xl font-bold lg:col-start-5">
              Visual design
            </h3>
            <p className="col-start-1 col-end-13 inline-block lg:col-start-5">
            ...
            <MDX
              components={{
                ol: (props) => (
                  <ol
                    className="col-start-1 col-end-13 list-outside list-decimal space-y-2 marker:text-gray-8 lg:col-start-4"
                    {...props}
                  />
                ),
              }}
            ...
            <p className="col-start-1 col-end-16 inline-block">
