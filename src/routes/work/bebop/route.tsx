...
/** next project link; keep name/urlSlug in sync with `../iss/route.tsx` issMeta */
const nextFromBebop = {
  name: "Where's the iss?",
  urlSlug: "iss",
} as const;

function BebopWorkPage() {
  return (
    <ProjectContainer key="bebopProj" backMessage={bebopMeta.backMessage}>
      ...
      <ProjectLayout projMeta={bebopMeta} nextProjMeta={nextFromBebop}>
