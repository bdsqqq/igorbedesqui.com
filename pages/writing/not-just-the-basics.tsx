    ...
    <Container backable backAnchor="/writing">
      <Band id="01" gridless>
        <div className="max-w-prose mx-auto space-y-4">
          ...
          <p>
            {`Both teach the importance of focusing on basic principles to avoid stupid mistakes. Being smart, creative, and innovative is important, but ignoring the risks that come with it is irresponsible; Allowing yourself to make big mistakes is an inherent part of the creative process.`}
          </p>
          ...
          <Accordion.Root type="single" collapsible>
            <Accordion.Item value="1">
              <Accordion.Trigger>
                {`Applying this to League made me and my friends win 90% of the matches we played.`}
              </Accordion.Trigger>
              <Accordion.Content>
                {`
          ...
          <p>
            <em className="text-gray-12">
              {`The consistent execution of fundamentals builds a strong foundation that serves as a safety net to allow innovation in the long term.`}
            </em>
          </p>

          <p>
            {`Now, I'm focusing on the basics of my work. The fine and detailed polish I strive for will come as I build “Just” the basics with care.`}{" "}
