...
/** sync with `../bebop/route.tsx` bebopMeta */
const nextFromWasmgif = {
  name: "Cowboy Bebop web poster",
  urlSlug: "bebop",
} as const;

function WasmGifWorkPage() {
  return (
    <ProjectContainer key="wasmGifProj" backMessage={wasmGifMeta.backMessage}>
      ...
      <ProjectLayout projMeta={wasmGifMeta} nextProjMeta={nextFromWasmgif}>
